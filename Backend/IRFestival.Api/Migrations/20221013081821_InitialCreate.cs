    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A music festival is a festival oriented towards music", 1, "Main Stage" },
                    { 2, "A music festival is a festival oriented towards music", 1, "Orange Room" },
                    { 3, "A music festival is a festival oriented towards music", 1, "StarDust" }
                });
